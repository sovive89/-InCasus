...
export const Route=createFileRoute("/cliente/assistente")({head:()=>({meta:[{title:"Assistente — Juris Agent"},{name:"description",content:"Converse com o assistente do escritório sobre seu caso."},{property:"og:title",content:"Assistente — Juris Agent"},{property:"og:description",content:"Converse com o assistente do escritório sobre seu caso."},{property:"og:type",content:"website"},{name:"twitter:card",content:"summary_large_image"}]}),component:Page});
